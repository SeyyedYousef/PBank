...
export const ServicesPage = () => {
    ...
    const slides = [
        {
            id: 'mobile-credit',
            badge: 'پیشنهاد ویژه',
            title: '۲۰٪ تخفیف شارژ برای خطوط روشن',
        ...
        {
            id: 'internet',
            badge: 'اینترنت نامحدود',
            title: 'بسته‌های شبانه با سرعت نور',
        ...
        },
        {
            id: 'electricity',
            badge: 'پاداش نقدی',
            title: '۵٪ بازگشت وجه در پرداخت قبض برق',
    ...
    const services = [
        { id: 'mobile-credit', icon: Smartphone, label: 'کریدت موبایل', color: 'text-blue-400', bg: 'bg-blue-400/10' },
        { id: 'electricity', icon: Zap, label: 'برق برشنا', color: 'text-amber-400', bg: 'bg-amber-400/10' },
        { id: 'internet', icon: Wifi, label: 'اینترنت', color: 'text-violet-400', bg: 'bg-violet-400/10' },
        { id: 'flights', icon: Plane, label: 'پرواز', color: 'text-emerald-400', bg: 'bg-emerald-400/10' },
        { id: 'taxes', icon: Building, label: 'مالیات', color: 'text-rose-400', bg: 'bg-rose-400/10' },
        { id: 'others', icon: MoreHorizontal, label: 'سایر', color: 'text-gray-400', bg: 'bg-white/5' },
    ];
    ...
    return (
        <PageTransition className="p-6 space-y-8 pb-32">
            <header className="pt-4 text-center">
                <h1 className="text-3xl font-[800] text-transparent bg-clip-text bg-gradient-to-r from-primary-glow to-white drop-shadow-lg">خدمات</h1>
            </header>
            ...
            <button
                type="button"
                className="relative h-48 w-full group cursor-pointer text-right outline-none focus-visible:ring-4 focus-visible:ring-primary/50 rounded-[32px] transition-shadow"
                onClick={() => navigate(`/services/${slides[currentSlide].id}`)}
                aria-label={`مشاهده جزئیات ${slides[currentSlide].title}`}
            >
                <AnimatePresence mode='wait'>
                    ...
                    >
                        <BentoCard variant="default" className="relative h-full overflow-hidden flex items-end p-0 border-white/10">
                            ...
                            <div className={`absolute top-0 right-0 w-32 h-32 ${slides[currentSlide].glowColor} blur-[50px] rounded-full pointer-events-none`} />
                            ...
                            <div className={`absolute -top-4 -left-4 w-24 h-24 bg-gradient-to-br ${slides[currentSlide].floatyColor} rounded-full blur-xl animate-pulse`} />
                        </BentoCard>
                    </motion.div>
                </AnimatePresence>
